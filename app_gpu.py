...
st.set_page_config(page_title="LLM Q&A", page_icon="🤖", layout="wide", )     
st.markdown(f"""
            <style>
...
n_batch = 10000  # Should be between 1 and n_ctx, consider the amount of VRAM in your GPU.
